...
export default function TextComponent ({ colormap, component, randomChars, obfuscated }) {
  ...
  const renderedText = component.obfuscated || (obfuscated && component.obfuscated !== false)
      ? <ObfuscatedText colormap={colormap} text={component.text} randomChars={randomChars} />
      : component.text;

  const renderedExtras = component.extra && Array.isArray(component.extra)
